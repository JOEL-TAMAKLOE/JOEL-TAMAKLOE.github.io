...
var typed = new Typed(".typing-text", {
    strings: ["Data Analysis", "Data Science", "Machine Learning", "Deep Learning", "Artificial Intelligence", "Project management", "Cybersecurity", "Computer Vision", "Creating Solutions"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
